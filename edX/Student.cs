...
namespace edXCourse
{
    public class Student : Person
    {
        ...
        public static string[] StudentInfo()
        {
            ...
            string[] arrStudentInformation = { student.FirstName, student.LastName, student.Address, student.City, student.Postcode, student.State, student.Country, student.BirthdayDate };
            ...
            string [] arrStudent = {studentInfoLine};
            return arrStudent;             
        }
        public static int TakeTest(int score)
        {
            return score;
