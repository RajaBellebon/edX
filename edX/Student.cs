...
namespace edXCourse
{
    public class Student
    {
        ...
        public static String[] GetStudentInformation()
        {
            ...
            string[] arr = { student.FirstName, student.LastName, student.Address1, student.Address2, student.City, student.Postcode, student.State, student.Country, student.BirthdayDate };
            return arr;
        }
